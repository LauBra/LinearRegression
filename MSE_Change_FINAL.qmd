...
![](ByHand1.jpg){fig-align="center"} Repeat process with B0 = 4 and B1 = 7.
...
These parameters are very similar to what we obtained from the `linear_reg()` function (and would be the same if we had sampled the MSE at that accurate decimal point)
